...
def build_html(by_series, photos_by_gallery=None):
    ...
    return (f'<!DOCTYPE html>\n<html lang="en">\n<head>\n'
            ...
            f'.nav-link{{position:fixed;top:1rem;right:1.2rem;font-family:Georgia,serif;font-size:0.72rem;letter-spacing:0.22em;text-transform:uppercase;color:rgba(0,0,0,0.38);text-decoration:none;z-index:100;}}\n'
            f'.nav-link:hover{{color:rgba(0,0,0,0.65);}}\n'
            f'</style>\n</head>\n<body>\n'
            f'  <a href="gallery.html" class="nav-link">VIP</a>\n'
